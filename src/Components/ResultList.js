...
const ResultList = () => {
  ...
  if (error) {
    <h3 className="font-semibold text-center mt-10 text-black">
      Oops! No Defination Found.☹️
    </h3>;
  }
  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl ">
      {response && (
        <div>
          <h3 className="text-2xl font-bold mt-2">Meaning & Definations: </h3>
          <MeaningList mean={response} />
          <h3 className="text-2xl font-bold mt-2">Examples: </h3>
          <Example mean={response} />
          <h3 className="text-2xl font-bold mt-2">Synonyms: </h3>
          <Synonym mean={response} />
          <h3 className="text-2xl font-bold mt-2">Antonyms: </h3>
